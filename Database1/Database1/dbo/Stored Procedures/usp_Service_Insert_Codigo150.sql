...
-- Description:	Recepción código 150 (Solicitar verificación biométrica)
-- =============================================
CREATE PROCEDURE [dbo].[usp_Service_Insert_Codigo150]
...
BEGIN
	...
	--begin transaction
		...
		Insert into [dbPrestoCibergestionBanorte].[dbo].[tblBiometria] (IdExpediente, EstatusVerificacion, MensajeVerificacion, TipoValidacion, TipoValidacionDesc, FolioUnicoIdentificador
												...
												, NumeroIdentificacion2, EjecutarVerificacionBiometrica, FechaAlta, Activo, Status250, Comentarios250)
			Select 
				  @idExpediente
				...
				, Biometria.value('tipoDocumento1[1]', 'varchar(10)') 
				, Biometria.value('tipoDocumentoDesc1[1]', 'varchar(1000)')
				, Biometria.value('idDocumento1[1]', 'varchar(1000)') 
				, Biometria.value('tipoDocumento2[1]', 'varchar(10)') 
				, Biometria.value('tipoDocumentoDesc2[1]', 'varchar(1000)')
				, Biometria.value('idDocumento2[1]', 'varchar(1000)')
		...
		values
			(@XmlData, 150, @idExpediente, @FolioBanco, 1, current_timestamp)
