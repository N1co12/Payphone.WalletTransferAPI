--use dbPrestoBanorte
CREATE PROCEDURE [dbo].[usp_Service_Insert_Codigo100_Presto]  
 ...
 begin transaction  
   ...
   Insert into dbo.tblHeader (nombre, idPrograma, destino, banco, rfc, crSucursal, noCaso, bancoCte, noCliente, usrAsignado, tipoCredito, fechaRegistro)  
    Select  
     ...
     , current_timestamp  
    from @XmlData.nodes('//IngresoPrestovm/Header')Catalog(Header)

  
  
   Select   
    @segmentoTitular = DatosPersonales.value('segmento[1]', 'varchar(500)')   
   from @XmlDatos.nodes('//XMLDatos/DatosPersonalesEntity/DatosPersonalesEntityVm') N1 (DatosPersonales)  
   ...
   from @XmlDatos.nodes('//XMLDatos/Evaluacion') N1 (Evaluacion)  
  
   Select  
     @tieneDispersion = PrestoAvaluoJuridico.value('tieneDispersion[1]', 'varchar(10)')   
   from @XmlDatos.nodes('//XMLDatos/PrestoAvaluoJuridico') N1 (PrestoAvaluoJuridico)  
  
   Select  
     @banderaCoefEndeudamiento = DatosEvaluacion.value('banderaCoefEndeudamiento[1]', 'varchar(5)')   
   from @XmlDatos.nodes('//XMLDatos/Evaluacion') N1 (DatosEvaluacion)  
   ...
   Insert into [dbPrestoCibergestionBanorte].[dbo].[tblIngreso_DatosGenerales]   
    ...
    from @XmlData.nodes('//IngresoPrestovm/Header') N1(Header)  
     cross apply @XmlData.nodes('//IngresoPrestovm/DatosPersonales/DatosPersonalesVm') N2(DatosPersonales)  
     cross apply @XmlData.nodes('//IngresoPrestovm/InicioPrestoAvaluoJuridico') N3(InicioPrestoAvaluoJuridico)  
     cross apply @XmlData.nodes('//IngresoPrestovm/DatosDomicilio/DatosDomicilioVm') N4(DatosDomicilio)   
     cross apply @XmlData.nodes('//IngresoPrestovm/DatosLaborales/DatosLaboralesVm') N5(DatosLaborales)   
   ...
   Insert into [dbPrestoCibergestionBanorte].[dbo].[tblIngreso_ParticipantesConyuge] (IdExpediente, conyuge_Nombre, conyuge_Rfc, conyuge_Nss, idUsuarioAlta, fechaAlta)  
    Select  
     ...
     , [IdUsuarioAlta] = 16  
     , [FechaAlta] = current_timestamp  
    from @XmlData.nodes('//IngresoPrestovm/DatosPersonales/DatosPersonalesVm') N1(Conyuge)  
   ...
   Insert into [dbPrestoCibergestionBanorte].[dbo].[tblIngreso_ParticipantesCoacreditado] (IdExpediente, coacreditado_nombre, coacreditado_rfc, coacreditado_curp, coacreditado_nss,  
    ...
    from @XmlData.nodes('//IngresoPrestovm/DatosPersonales/DatosPersonalesVm') N1(Coacreditado)  
     left join [dbPrestoCibergestionBanorte].[dbo].[CatNacionalidad] B on B.idBanco = Coacreditado.value('codNacionalidad[1]', 'nvarchar(3)')  
     cross apply @XmlData.nodes('//IngresoPrestovm/DatosDomicilio/DatosDomicilioVm') N2(DatosDomicilio)   
     cross apply @XmlData.nodes('//IngresoPrestovm/DatosLaborales/DatosLaboralesVm') N3(DatosLaborales)   
    where   
   ...
   Insert into [dbPrestoCibergestionBanorte].[dbo].[tblIngreso_ParticipantesGarante] (IdExpediente, garante_Nombre, garante_Rfc, garante_Curp, garante_Nss,  
    ...
    from @XmlData.nodes('//IngresoPrestovm/DatosPersonales/DatosPersonalesVm') N1(Garante)  
   ...
   Insert into [dbPrestoCibergestionBanorte].[dbo].[tblIngreso_ParticipantesSolidario] (IdExpediente, solidario_Nombre, solidario_Rfc, solidario_Curp, solidario_Nss,  
    ...
    from @XmlData.nodes('//IngresoPrestovm/DatosPersonales/DatosPersonalesVm') N1(FiadorSolidario)  
   ...
   Insert into [dbPrestoCibergestionBanorte].[dbo].[tblIngreso_DatosCredito] (idExpediente, montoSolicitado, tasaInteres, idPlazo, idTipoComision, idProducto,  
    ...
    , [IdUsuarioAlta] = 16  
    , [FechaAlta] = current_timestamp  
   from @XmlData.nodes('//IngresoPrestovm/Evaluacion') N1(EvalucionCREa)  
    cross apply @XmlData.nodes('//IngresoPrestovm/DatosOperacion') N2(DatosOperacion)  
    cross apply @XmlData.nodes('//IngresoPrestovm/FillersConciliacionJuridico') N3(FillerJuridico)  
    cross apply @XmlData.nodes('//IngresoPrestovm/Fillers') N4(Fillers)  
    cross apply @XmlData.nodes('//IngresoPrestovm/InicioPrestoAvaluoJuridico') N5(InicioPrestoAvaluoJuridico)  
   ...
   set @territorial = (Select top 1  
         B.idTerritorio  
        from @XmlData.nodes('//IngresoPrestovm/CREAEjecutivos/CREAEjecutivosVm') N1(Ejecutivos)  
   ...
   Insert into [dbPrestoCibergestionBanorte].[dbo].[tblIngreso_DatosVentas] (idExpediente, idEjecutivoVentas, claveEjecutivo, idCanal, correoElectronicoDV, idSucursal,  
    ...
    from @XmlData.nodes('//IngresoPrestovm/CREAEjecutivos/CREAEjecutivosVm') N1(EvalucionCREa)  
     cross apply @XmlData.nodes('//IngresoPrestovm/DatosOperacion') N2(DatosOperacion)  
     cross apply @XmlData.nodes('//IngresoPrestovm/InicioPrestoAvaluoJuridico') N3(InicioPrestoAvaluoJuridico)  
     cross apply @XmlData.nodes('//IngresoPrestovm/DatosLaborales/DatosLaboralesVm') N4(DatosLaborales)   
   ...
   Insert into [dbPrestoCibergestionBanorte].[dbo].[tblIngreso_ValidaExpediente_Asignacion] (IdExpediente, idUsuarioAlta, fechaAlta, activo)  
    Select  
     ...
     , [FechaAlta] = current_timestamp  
     , [Activo] = cast(1 as bit)  
    from @XmlData.nodes('//IngresoPrestovm/DatosOperacion') N1(DatosOperacion)  
   ...
   Insert into [dbPrestoCibergestionBanorte].[dbo].[tblIngreso_DatosInmueble] (IdExpediente, calleInmueble, numeroExterior, numeroInterior, codigoPostal,  
    ...
    Select  
     ...
     , [FechaAlta] = current_timestamp  
     , [Activo] = cast(1 as bit)  
    from @XmlData.nodes('//IngresoPrestovm/GarantiasVm/GarantiasVm') N1(Garantias)  
   ...
   from @XmlData.nodes('//IngresoPrestovm/InicioPrestoAvaluoJuridico') N1(Evaluacion)  
   ...
   Insert into [dbPrestoCibergestionBanorte].[dbo].[tblGravamen] (IdExpediente, NoGravamen, NoGarantia, Acreedor, IdBancoAcreedor, Monto, Fecha, IdTipoMoneda, FechaAlta, IdUsuarioAlta)  
    Select  
     ...
     , [FechaAlta] = current_timestamp  
     , [IdUsuarioAlta] = 16  
    from @XmlData.nodes('//IngresoPrestovm/Gravamen/GravamenVm') N1(Gravamen)  
  
  
   -- Vendedor  
   Declare @IdTipoPersona int = (Select Garantias.value('esPromotor[1]', 'nvarchar(50)') from @XmlData.nodes('//IngresoPrestovm/Garantias/GarantiasVm') N1(Garantias) where Garantias.value('noGarantia[1]', 'int') in (1))  
   ...
   Insert into [dbPrestoCibergestionBanorte].[dbo].[tblAvaluos_Vendedor] (IdExpediente, NoVendedor, IdTipoPersona, RazonSocialEmpresa, Nombre, Rfc, TelefonoCasa,  
    ...
    Select   
     ...
     , [IdUsuarioAlta] = 16  
     , [FechaAlta] = current_timestamp  
    from @XmlData.nodes('//IngresoPrestovm/Vendedor/VendedorVm') N1(Vendedor)  
   ...
   Insert into [dbPrestoCibergestionBanorte].[dbo].[tblTerritorial] (id, noCaso, idExpediente, tipoEjecutivo, claveEjecutivo, nombreEjecutivo, crSucursal,   
    ...
    from @XmlData.nodes('//IngresoPrestovm/CREAEjecutivos/CREAEjecutivosVm') N1(Ejecutivos)  
     cross apply @XmlData.nodes('//IngresoPrestovm/Header') N2(Header)  
   ...
   Insert into [dbPrestoCibergestionBanorte].[dbo].[tblDataCREa_Informacion] (idExpediente, decreto, fechaEvaluacion, idTipoPagoCliente, idTipoPagoVendedor, bancoCte,   
    ...
    from @XmlData.nodes('//IngresoPrestovm/Evaluacion') N1(Evaluacion)  
     cross apply @XmlData.nodes('//IngresoPrestovm/InicioPrestoAvaluoJuridico') N2(InicioPrestoJuridico)  
     cross apply @XmlData.nodes('//IngresoPrestovm/Vendedor/VendedorVm') N3(Vendedor)  
     cross apply @XmlData.nodes('//IngresoPrestovm/Header') N4(Header)  
     cross apply @XmlData.nodes('//IngresoPrestovm/DatosOperacion') N5(DatosOperacion)  
      inner join [dbPrestoCibergestionBanorte].[dbo].[CatTipoComision] B on B.Id = DatosOperacion.value('idTipoComision[1]', 'int')  
     cross apply @XmlData.nodes('//IngresoPrestovm/Fillers') N6(Fillers)  
   ...
   Insert into [dbPrestoCibergestionBanorte].[dbo].[tblBiometria] (IdExpediente, EstatusVerificacion, MensajeVerificacion, TipoValidacion, TipoValidacionDesc, FolioUnicoIdentificador  
    ...
    Select   
     ...
     , current_timestamp  
     , 1  
    from @XmlDatos.nodes('//XMLDatos/Biometria') N1 (Biometria)  
   ...
   Insert into [dbPrestoCibergestionBanorte].[dbo].[tblXmlDatos_DatosOperacion] (IdExpediente, FolioCreditoPreautorizado, IdDesarrolladorEspecial, IdDesarrolloEspecial, IdCampana, FechaAlta)  
    Select   
     ...
     , current_timestamp  
    from @XmlDatos.nodes('//XMLDatos/DatosOperacion') N1 (DatosOperacion)  
   ...
   -- Result  
   Select [Id] = @idExpediente, [Estatus] = CAST(1 AS BIT), [Mensaje] = NULL  
 ...
 begin catch  
  if(@@trancount > 0)        
   begin      
	...
	SELECT [Id] = 0, [Estatus] = CAST(0 AS BIT), [Mensaje] = @ErrMsg   
