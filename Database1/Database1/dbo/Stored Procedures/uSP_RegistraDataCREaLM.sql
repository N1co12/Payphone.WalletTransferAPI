...
-- exec [uSP_RegistraDataCREaLM] ''
-- =============================================
CREATE PROCEDURE [dbo].[uSP_RegistraDataCREaLM]
...
BEGIN
	...
	insert into dbPrestoBanorte.[dbo].[tblDataCREa]([xmlDataCREa],fechaRegistro) values(@xmlDataCREa,getdate());
	insert into dbPrestoCibergestionBanorte.[dbo].[tblDataCREa]([xmlDataCREa],fechaRegistro) values(@xmlDataCREa,getdate());
	 set @id= @@identity
...
update  dbPrestoBanorte.[dbo].[tblDataCREa] set codigo=@resultadopaso, noCaso=@noCaso where id=@id
update  dbPrestoCibergestionBanorte.[dbo].[tblDataCREa] set codigo=@resultadopaso, noCaso=@noCaso where id=@id
