...
--exec  uSp_ConsultaXMLDataCREaProduccion '201602007807021'
-- =============================================
CREATE PROCEDURE [dbo].[uSp_ConsultaXMLDataCREaProduccion]
...
AS 
	...
	-- interfering with SELECT statements.
        ...
        SET @idMax=(SELECT MAX(id) FROM dbo.tblDataCREa WHERE noCaso=@noCaso and codigo in(100,140))
       ...
       SET @xmlDataCREa=( SELECT xmlDataCREa FROM dbo.tblDataCREa WHERE id=@idMax)
        ...
        SELECT  Container.ContainerCol.value('resultadopaso[1]', 'int') AS resultadopaso ,
                ...
                Container.ContainerCol.value('comentarios[1]',
                                             'nvarchar(3000)') AS comentarios ,
  ...
  --              AS Container ( ContainerCol ), @xmlDataCREa.nodes('//DataCREa//DatosDomicilioCREa//DatosDomicilio') AS Container2 ( ContainerCol2 )
        ...
        SELECT  Container.ContainerCol.value('idSubproducto[1]',
                ...
                Container.ContainerCol.value('idlsReferenciaBroker[1]', 'nvarchar(8)') AS idlsReferenciaBroker ,
        ...
        SELECT  Container.ContainerCol.value('noGarantia[1]', 'int') AS noGarantia ,
                ...
                Container.ContainerCol.value('m2construccion[1]',
                                             'decimal(8, 2)') AS m2construccion ,
                Container.ContainerCol.value('m2terreno[1]', 'decimal(8, 2)') AS m2terreno ,
   ...
   --                  --fillersconAva 10
        ...
        SELECT  Container.ContainerCol.value('noCtaChequesClientes[1]', 'nvarchar(30)') AS noCtaChequesClientes ,
